...
const SEO = ({ title, description, slug="", pageImage }) => {
  ...
  return (
    <Helmet htmlAttributes={{ lang: "en" }} title={`${title} | ${siteTitle}`}>
      ...
      <meta property="og:image" content={`${siteUrl}${pageImage || image}`} />
      ...
      <meta name="twitter:image" content={`${siteUrl}${pageImage || image}`} />
    </Helmet>
  )
}
